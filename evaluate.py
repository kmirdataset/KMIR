"""Official evaluation script for KMIR version 1.0.

To use this script, use command python evaluate.py 
"""
import argparse
import collections
import json
...
def parse_args():
    parser = argparse.ArgumentParser('Official evaluation script for KMIR version 1.0.')
